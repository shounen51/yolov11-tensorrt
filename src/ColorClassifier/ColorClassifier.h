...
static const std::vector<std::string> ColorLabelsString = {
    ...
    "red", "orange", "brown", "yellow", "green", "cyan", "blue", "purple", "pink" // IsColor
};
...
enum ColorLabels : unsigned char
{
    ...
    color_red, color_orange, color_brown, color_yellow, color_green, color_cyan, color_blue, color_purple, color_pink   // IsColor
};
